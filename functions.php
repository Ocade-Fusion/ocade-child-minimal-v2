...
define("ORGANISATION_GITHUB", '**NOM_ORGANISATION_GITHUB**'); // Nom de l'organisation GitHub
define("DEPOT_GITHUB", '**NOM_DEPOT_GITHUB**'); // Nom du dépôt GitHub
define('OCADE_IS_THEME', true); // True = Thème / False = Plugin
define('OCADE_IS_CHILD_THEME', true); // Est le thème enfant ?
